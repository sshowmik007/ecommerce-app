...
const Login = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center bg-slate-100 w-full min-h-screen flex-1 px-20 py-2 text-center'>
      <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
          ...
          <div className='w-2/5 bg-purple-600 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12'>
            {/* <p>SIGN UP</p> */}
